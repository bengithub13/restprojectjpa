...
import com.restproject.jms.JmsMessageSender;
 
@Controller
public class MainController {
	 @Autowired
	    private JmsMessageSender messageProducer;
// login endpoint-	 http://localhost:8181/rest-project/services/springmvc/login
...
// make sure activemq broker is up and running if you want to send a jms message	     
//			messageProducer		
//			  .sendText("Send this message to default destination. LOGGED IN..WELCOME!");
 ...
 //get spring sceurity Authetication object represeting the signin user (principal)
